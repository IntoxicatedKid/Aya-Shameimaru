...
{
    public sealed class AyaSuspiciousInterviewDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(AyaSuspiciousInterview);
        }
        ...
        [EntityLogic(typeof(AyaSuspiciousInterviewDef))]
        public sealed class AyaSuspiciousInterview : Card
        {
